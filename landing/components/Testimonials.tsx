...
const TESTIMONIALS = [
  {
    quote:
      "GhostDesk стал вторым мозгом на собеседованиях. Подсказки с примерными ответами и тайм-коды экономят часы подготовки.",
    name: "Анна Морозова",
  ...
  {
    quote:
      "Команде продаж стало легче вести диалоги: GhostDesk подсказывает, когда углубиться в боли клиента и что записать в CRM.",
    name: "Вадим Сафронов",
